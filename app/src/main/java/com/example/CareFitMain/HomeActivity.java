...
public class HomeActivity extends AppCompatActivity  {
    ...
    private CardView cardView, trainerCard, exerciseCard,dietCard, meditationCard, instructorCard ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        images.add(new SlideModel(R.drawable.diet, null));
        images.add(new SlideModel("https://static.vecteezy.com/system/resources/previews/000/223/249/original/ketogenic-diet-food-vector.jpg","Load from URL", null));
        images.add(new SlideModel(R.drawable.diet, null));
